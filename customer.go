...
type Customer struct {
	...
	DefaultDeliveryTypes     DefaultDeliveryTypes `json:"DefaultDeliveryTypes,omitempty"` // The properties for this object is listed in the table for “Default Delivery Types”.
	DefaultTemplates         DefaultTemplates     `json:"DefaultTemplates,omitempty"`     // The properties for this object is listed in the table for “Default Templates”.
